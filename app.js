...
async function main(){
    try{
        db = await mongoose.connect("mongodb+srv://jeromepchallet:Ujc5ZQfJqCjYLqgh@cluster0.xb92egm.mongodb.net/?retryWrites=true&w=majority/todolistDB", { useNewUrlParser: true, useUnifiedTopology: true });
...
//mongoose.connect("mongodb+srv://jeromepchallet:Ujc5ZQfJqCjYLqgh@cluster0.xb92egm.mongodb.net/?retryWrites=true&w=majority/todolistDB", { useNewUrlParser: true, useUnifiedTopology: true });
